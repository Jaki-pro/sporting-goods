    ...
    <div className="p-12">
      ...
      <div className="mx-4 space-y-3">
        {products?.map((product: TProduct) => (
          <div
            key={product._id}
            className="bg-[#606C38] rounded-md flex   items-center p-3 border"
          >
            <div className="md:mr-8 mr-4 flex-1 text-white">
            ...
            <div className="flex-1 sm:flex gap-4">
              ...
              {/* <p>Time</p> */}
              <p className="flex-1 text-[white]">Price: {product.price}$</p>
            </div>
            <div className="flex sm:flex-row flex-col gap-2">
              <NavLink to={`/products/update-product/${product._id}`}>
                <Button type="primary" className="bg-[white]" ghost>
                  Edit
